# Spectrobe Desktop Pet ![Spectrobe Switch Mode](Assets/Art/Sprites/switch.png)
...
Place cursor over the Spectrobe and use Mouse Wheel or touchpad zoom to make the Spectrobe bigger or smaller.  
